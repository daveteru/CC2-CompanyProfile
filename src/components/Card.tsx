...
export default function Card({ name, petname, breed,age, desc, tindakan,img }: cardprops) {
  return (
    <div className="items-center justify-center flex">
      {" "}
      <div className="bg-[#FFFFFF] md:w-100 h-150 rounded-3xl overflow-hidden  flex flex-col  text-[#323F51]">
          <div className="w-full h-120  bg-amber-300 overflow-hidden ">
            <img src={img} alt="" className="object-cover object-center w-full h-full" loading="lazy" />
          </div>
