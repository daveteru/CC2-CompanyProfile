  ...
  return (
    <div className="w-screen h-fit bg-[#B0E4E8] ">
      <section className="w-screen h-fit grid grid-cols-2 container mx-auto ">
        ...
        <article className="relative w-full h-200  flex flex-col justify-between items-center text-center  p-30 gap-10 overflow-hidden">
          ...
          <button className="border w-100 rounded-full border-blue-400 px-5 py-2 cursor-pointer bg-blue-400 hover:bg-blue-100 text-white hover:text-blue-900 font-bold drop-shadow-[0px_8px_0px_rgba(25,118,210,1)]   active:translate-y-2 active:drop-shadow-none transition-all">BERGABUNG DENGAN KAMI</button>
